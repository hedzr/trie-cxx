...
#ifndef TRIE_CXX_X_UTIL_HH
#define TRIE_CXX_X_UTIL_HH
...
//
    ...
    public:
        ...
        streamer_any()
            : any_visitors{
                      ...
                      to_any_visitor<std::chrono::nanoseconds>([](std::ostream &os, const std::chrono::nanoseconds &x) { trie::chrono::format_duration(os, x); }),
                      to_any_visitor<std::chrono::microseconds>([](std::ostream &os, const std::chrono::microseconds &x) { trie::chrono::format_duration(os, x); }),
                      to_any_visitor<std::chrono::milliseconds>([](std::ostream &os, const std::chrono::milliseconds &x) { trie::chrono::format_duration(os, x); }),
                      to_any_visitor<std::chrono::seconds>([](std::ostream &os, const std::chrono::seconds &x) { trie::chrono::format_duration(os, x); }),
                      to_any_visitor<std::chrono::minutes>([](std::ostream &os, const std::chrono::minutes &x) { trie::chrono::format_duration(os, x); }),
                      to_any_visitor<std::chrono::hours>([](std::ostream &os, const std::chrono::hours &x) { trie::chrono::format_duration(os, x); }),
	...
	inline void visit_any_as(std::any const &, Visitor &&) {
		trie_throw_line("std::any contained no suitable type, unable to visit");
	}
...
#if !defined(__DIFF_ID_SYSTEM_DEFINED)
#define __DIFF_ID_SYSTEM_DEFINED
#include <string_view>
#include <type_traits>
#include <utility>
// ------------------- id
...
#endif // __DIFF_ID_SYSTEM_DEFINED

#if !defined(__DIFF_FACTORY_T_DEFINED)
#define __DIFF_FACTORY_T_DEFINED
namespace trie::util::factory {
...
#endif // __DIFF_FACTORY_T_DEFINED


#endif //TRIE_CXX_X_UTIL_HH
