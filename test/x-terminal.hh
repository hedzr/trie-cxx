...
#ifndef TRIE_CXX_X_TERMINAL_HH
#define TRIE_CXX_X_TERMINAL_HH
...
namespace trie::terminal::colors {
...
#undef DEF_MODIFIER
	...
	public:
		...
		//
		//    using namespace trie::terminal::colors;
